...
<img src="../man/figures/rGeoCBI.png" alt="How good was that burn?" width="500" />
<br/>
...
hexSticker::sticker(
  ...
  package = "rGeoCBI", p_x = 1, p_y = 0.7, p_size = 32,
  p_family = "fredericka", p_color = "#ffffff",
  url = "dbca-wa.github.io/rGeoCBI", u_size = 4, u_color = "#ffffff",

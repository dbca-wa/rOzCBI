...
* The GeoCBI burn grading form is included in three versions in this package:
  * ODK Build save file (resume form design from this file):
    `system.file("odk/BurnGrading01.odkbuild", package = "rGeoCBI")`
  * XForm (upload to ODK Central): 
    `system.file("odk/BurnGrading01.xml", package = "rGeoCBI")`
  * XlsForm (can edit by hand and add embedded media): 
    `system.file("odk/BurnGrading01.xlsx", package = "rGeoCBI")`
